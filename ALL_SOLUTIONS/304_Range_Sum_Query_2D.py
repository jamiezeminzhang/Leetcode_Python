# -*- coding: utf-8 -*-
"""
Created on Tue Feb 23 10:50:39 2016

304. Range Sum Query 2D - Immutable My Submissions Question

Total Accepted: 8372 Total Submissions: 38453 Difficulty: Medium
...
class NumMatrix(object):
    ...
    def sumRegion(self, row1, col1, row2, col2):
        ...
        elif row1 == 0: return self.matrix[row2][col2] - self.matrix[row2][col1-1]
        elif col1 == 0: return self.matrix[row2][col2] - self.matrix[row1-1][col2]
        else:
            return self.matrix[row2][col2]-self.matrix[row1-1][col2]-\
            self.matrix[row2][col1-1]+self.matrix[row1-1][col1-1]
